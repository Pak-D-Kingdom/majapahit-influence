...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - Majapahit Influence</title>
    ...
    <style>
        ...
        .sidebar .nav-link { color: #94a3b8; font-weight: 500; padding: 0.75rem 1rem; border-radius: 0.5rem; margin-bottom: 0.25rem; }
    ...
    <div class="d-flex">
        ...
        <div class="sidebar p-3" style="width: 260px;">
            <div class="d-flex align-items-center mb-4 px-2 pt-2">
                <i class="bi bi-gem fs-4 text-warning me-2"></i>
                <span class="fs-5 fw-bold text-white">Majapahit Admin</span>
            </div>
