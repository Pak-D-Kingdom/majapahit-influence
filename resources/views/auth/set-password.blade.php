    ...
    <div class="max-w-md w-full mx-auto my-auto">
        ...
        <div class="bg-white rounded-3xl border border-blue-100/80 shadow-xl shadow-blue-950/5 p-7 sm:p-9 backdrop-blur-sm">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-2xl font-black text-[#0c3685] tracking-tight">Aktivasi Akun KOL Anda</h1>
                <p class="text-xs text-slate-500 mt-1 leading-relaxed">
                    Buat kata sandi baru untuk mengakses portal dan campaign ekosistem KERAJAAN.
                </p>
            </div>
