    ...
    <div class="container">
        ...
        <div class="demo-header text-center">
            ...
            <h2 class="demo-heading">
                Lihat Bagaimana KERAJAAN
                <span class="demo-heading-highlight">Bekerja.</span>
            </h2>

            <p class="demo-subheading">
                Jelajahi platform dan temukan bagaimana brand dan creator saling terhubung, berkolaborasi, dan mengelola kampanye bersama.
            </p>
            ...
            <div class="demo-actions-bar">
                <button type="button" class="btn-watch-demo" id="btnOpenDemoModal" aria-haspopup="dialog" aria-controls="demoVideoModal">
                    ...
                    <span class="btn-watch-text">Tonton Demo</span>
                    <span class="btn-watch-badge">Video 30 Detik</span>
                </button>
            </div>
        </div>
        ...
        <div class="demo-nav-wrapper">
            <div class="demo-steps-nav" id="demoStepsNav" role="tablist" aria-label="Tahapan Alur Interaktif">
                <button type="button" class="demo-step-btn active" data-step="0" role="tab" aria-selected="true" aria-controls="demoSlide0" id="stepTab0">
                    ...
                    <div class="step-text">
                        <strong class="step-title">Temukan</strong>
                        <span class="step-desc">Temukan Creator & KOL</span>
                    </div>
                ...
                <button type="button" class="demo-step-btn" data-step="1" role="tab" aria-selected="false" aria-controls="demoSlide1" id="stepTab1">
                    ...
                    <div class="step-text">
                        <strong class="step-title">Eksplorasi</strong>
                ...
                <button type="button" class="demo-step-btn" data-step="2" role="tab" aria-selected="false" aria-controls="demoSlide2" id="stepTab2">
                    ...
                    <div class="step-text">
                        <strong class="step-title">Kampanye</strong>
                        <span class="step-desc">Buat Brief & Kebutuhan</span>
                    </div>
                    <div class="step-progress-track">
                        <div class="step-progress-fill"></div>
                    </div>
                ...
                <button type="button" class="demo-step-btn" data-step="3" role="tab" aria-selected="false" aria-controls="demoSlide3" id="stepTab3">
                    ...
                    <div class="step-text">
                        <strong class="step-title">Kolaborasi</strong>
                        <span class="step-desc">Eksekusi & Tinjau Konten</span>
                    </div>
                    <div class="step-progress-track">
                        <div class="step-progress-fill"></div>
                    </div>
                ...
                <button type="button" class="demo-step-btn" data-step="4" role="tab" aria-selected="false" aria-controls="demoSlide4" id="stepTab4">
                    ...
                    <div class="step-text">
                        <strong class="step-title">Pantau</strong>
                        <span class="step-desc">Pantau Metrik & Hasil</span>
                    </div>
                    <div class="step-progress-track">
                        <div class="step-progress-fill"></div>
                    </div>
                        ...
                        <div class="slide-inner">
                            ...
                            <div class="slide-top-filter">
                                <div class="mock-search-box" id="step1SearchTarget">
                                    ...
                                    <span class="mock-search-placeholder">Cari creator kuliner, fashion, kecantikan, lifestyle...</span>
                                ...
                                <div class="mock-category-pills">
                                    ...
                                    <span class="mock-pill">Kecantikan & Perawatan</span>
                            ...
                            <div class="slide-creators-grid">
                                ...
                                <div class="mock-creator-card card-featured" id="step1CreatorTarget">
                                    <div class="mock-card-media">
                                        ...
                                        <span class="mock-rank-badge">#01 Peringkat Teratas</span>
                                        <span class="mock-match-badge">98% Cocok</span>
                                    </div>
                                    <div class="mock-card-content">
                                        ...
                                        <span class="mock-handle">@sarah.amelia • Kuliner & F&B</span>
                                ...
                                <div class="mock-creator-card">
                                    <div class="mock-card-media">
                                        ...
                                        <span class="mock-rank-badge">#02 Sedang Tren</span>
                                    </div>
                                    <div class="mock-card-content">
                                        <div class="mock-creator-title">
                                            <h4>Dimas Pratama</h4>
                                        ...
                                        <span class="mock-handle">@dimas_tech • Teknologi & Gadget</span>
                                        <div class="mock-stats-row">
                                            <div>
                                                <strong>280K</strong>
                                                <small>Pengikut</small>
                                ...
                                <div class="mock-creator-card hide-mobile">
                                    <div class="mock-card-media">
                                        ...
                                        <span class="mock-rank-badge">#03 Naik Daun</span>
                                    </div>
                                    <div class="mock-card-content">
                                        <div class="mock-creator-title">
                                            <h4>Clara Sinta</h4>
                                        ...
                                        <span class="mock-handle">@clarasinta • Kecantikan & Perawatan</span>
                                        <div class="mock-stats-row">
                                            <div>
                                                <strong>95K</strong>
                                                <small>Pengikut</small>
                            ...
                            <div class="mock-profile-header">
                                <div class="mock-profile-top">
                                    ...
                                    <div class="mock-profile-info">
                                        <div class="mock-profile-name-row">
                                            <h3>Sarah Amelia</h3>
                                            <span class="mock-cat-badge">Creator Kuliner & Lifestyle</span>
                                            <span class="mock-rate-badge"><i class="bi bi-star-fill"></i> 4.9 (38 Ulasan)</span>
                                        </div>
                                ...
                                <div class="mock-metrics-row">
                                    ...
                                    <div class="metric-card hide-mobile">
                                        ...
                                        <span class="metric-label">Rata-rata Tayangan</span>
                                    ...
                                    <div class="portfolio-cards-row">
                                        <div class="portfolio-mini-card">
                                            ...
                                            <div class="portfolio-info">
                                                <strong>Peluncuran Pak De Coffee</strong>
                                                <small><i class="bi bi-eye"></i> 89.2K Tayangan • 8.4K Suka</small>
                                            </div>
                                        </div>
                                        <div class="portfolio-mini-card">
                                            ...
                                            <span class="play-overlay"><i class="bi bi-play-fill"></i></span>
                                            <div class="portfolio-info">
                                                <strong>Review Camilan Lokal</strong>
                                                <small><i class="bi bi-eye"></i> 54.1K Tayangan • 5.1K Suka</small>
                                            </div>
                                        </div>
                                        <div class="portfolio-mini-card hide-mobile">
                                            ...
                                            <span class="play-overlay"><i class="bi bi-play-fill"></i></span>
                                            <div class="portfolio-info">
                                                <strong>Tantangan Kuliner Pedas</strong>
                                                <small><i class="bi bi-eye"></i> 68.3K Tayangan • 6.7K Suka</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="slide-inner">
                            <div class="mock-campaign-builder">
                                <div class="campaign-builder-header">
                                    <div>
                                        <span class="builder-eyebrow">PENGATURAN KAMPANYE</span>
                                        <h3>Buat Kampanye & Brief Kolaborasi</h3>
                                    </div>
                                ...
                                <div class="campaign-form-grid">
                                    ...
                                    <div class="campaign-form-card">
                                        ...
                                        <div class="form-row">
                                            <label class="form-label">Tujuan Kampanye & Pesan Utama</label>
                                            <div class="mock-input-textarea">
                                                <span>Fokus pada rasa gula aren autentik dan promo grand launching Beli 1 Gratis 1 untuk audiens Surabaya & sekitarnya.</span>
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <label class="form-label">Kebutuhan Konten (Deliverables)</label>
                                            <div class="deliverable-tags">
                                                <span class="deliverable-tag checked"><i class="bi bi-check2"></i> 1x Video Instagram Reels Khusus</span>
                                                <span class="deliverable-tag checked"><i class="bi bi-check2"></i> 2x Instagram Story (Tautan Pembelian)</span>
                                                <span class="deliverable-tag checked"><i class="bi bi-check2"></i> 1x Video TikTok</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="campaign-summary-card">
                                        ...
                                        <div class="summary-stat-list">
                                            <div class="summary-stat-item">
                                                <span>Kebutuhan Creator</span>
                                                <strong>5 KOL (Kategori Kuliner)</strong>
                                            </div>
                                            <div class="summary-stat-item">
                                                <span>Estimasi Target Jangkauan</span>
                                        ...
                                        <button type="button" class="mock-btn-action mock-btn-primary w-full" id="step3PublishBtn">
                                            ...
                                            <span>Publikasikan & Undang Creator</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mock-collab-workspace">
                                <div class="collab-topbar">
                                    ...
                                    <div class="collab-stage-badge">
                                        ...
                                        <span>Tahap 3: Tinjau Draft Konten</span>
                                    </div>
                                </div>
                                ...
                                <div class="collab-timeline-bar">
                                    ...
                                    <div class="timeline-step active">
                                        ...
                                        <span class="tl-text">3. Tinjau Draft</span>
                                    </div>
                                    <div class="timeline-step">
                                        <span class="tl-icon">4</span>
                                        <span class="tl-text">4. Publikasi & Pembayaran</span>
                                    </div>
                                </div>
                                ...
                                <div class="collab-draft-box">
                                    ...
                                    <div class="draft-details-side">
                                        <div class="draft-meta-head">
                                            ...
                                            <span class="draft-ready-badge">Menunggu Persetujuan Brand</span>
                                        </div>

                                        <p class="draft-notes">
                                            "Halo tim Pak De, draft reels review menu baru sudah selesai! Nuansa visual hangat, hook 3 detik pertama sangat memikat, dan promo BOGO sudah disertakan dengan jelas."
                                        </p>

                                        <div class="draft-actions-row">
                                            <button type="button" class="mock-btn-action mock-btn-success" id="step4ApproveBtn">
                                                <i class="bi bi-check-circle-fill"></i>
                                                <span>Setujui Draft Konten</span>
                                            </button>
                                            <button type="button" class="mock-btn-action mock-btn-secondary">
                        ...
                        <div class="slide-inner">
                            <div class="mock-track-dashboard">
                                <div class="track-header">
                                    <div>
                                        <span class="track-eyebrow">ANALITIK PERFORMA REAL-TIME</span>
                                        <h3>Kampanye Pak De Coffee — Ringkasan</h3>
                                    </div>
                                ...
                                <div class="track-kpis-grid">
                                    ...
                                    <div class="kpi-card highlight-kpi">
                                        <span class="kpi-label">Konversi & Estimasi Hasil</span>
                                        <strong class="kpi-num text-[#0b64d4]">3.8x ROI</strong>
                                        <small class="kpi-subtext">Rp 57.000.000 Est. Penjualan</small>
                                    </div>
                                </div>
                                ...
                                <div class="track-analytics-split">
                                    ...
                                    <div class="analytics-creators-box">
                                        <div class="chart-box-header">
                                            ...
                                            <small>Performa per Creator</small>
                                        </div>
                                        ...
                                        <button type="button" class="mock-btn-action mock-btn-secondary w-full" id="step5DownloadBtn">
                                            ...
                                            <span>Unduh Laporan Performa (PDF)</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-card">
        <div class="modal-card-header">
            <div class="modal-title-wrap">
                ...
                <div>
                    <h3 id="demoModalTitle" class="modal-title">KERAJAAN — Panduan & Alur Platform</h3>
                            ...
                            <div class="fallback-stage">
                                <div class="fallback-screen-display" id="fallbackScreenDisplay">
                                    <div class="fallback-step-content" id="fallbackStepContent">
                                        <div class="fallback-badge" id="fallbackStepBadge">LANGKAH 01 DARI 05</div>
                                        <h4 id="fallbackStepTitle">Temukan & Filter Creator</h4>
                                        <p id="fallbackStepDesc">Jelajahi lebih dari 500+ creator terkurasi dengan filter kategori dan analitik keterlibatan langsung.</p>
                                    </div>
                                </div>
