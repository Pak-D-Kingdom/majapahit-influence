...
@section('content')
    ...
    <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
            ...
            <h2 class="mt-1 text-2xl sm:text-3xl font-extrabold tracking-tight text-[#071d49] font-heading">Profil Saya</h2>
    ...
    <div class="relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-br from-[#071d49] via-[#0c3685] to-[#04102b] p-6 text-white shadow-xl shadow-[#071d49]/15 sm:p-8">
        ...
        <div class="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex flex-col gap-5 sm:flex-row sm:items-center">
                {{-- Avatar --}}
                <div class="relative size-24 shrink-0 overflow-hidden rounded-2xl border-2 border-white/20 bg-gradient-to-br from-[#0b64d4] to-[#1698f6] shadow-lg shadow-[#0b64d4]/30 sm:size-28">
                    ...
                    @endif
                    <span class="absolute bottom-1 right-1 size-4 rounded-full border-2 border-[#071d49] {{ $profile->status === 'aktif' ? 'bg-emerald-400' : 'bg-amber-400' }}" title="Status: {{ ucfirst($profile->status) }}"></span>
                </div>
                ...
                <div>
                    <div class="flex flex-wrap items-center gap-2.5">
                        ...
                        @if ($profile->tier)
                            <span class="inline-flex items-center gap-1.5 rounded-full border border-blue-400/30 bg-blue-500/20 px-3 py-0.5 text-xs font-bold text-[#78a5d6] backdrop-blur-xs font-heading">
                                <i class="bi bi-award-fill"></i>
                                Tier {{ $profile->tier->name }}
                            </span>
                        @endif
                        <span class="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/10 px-2.5 py-0.5 text-xs font-semibold text-white/90 backdrop-blur-xs">
                            Komisi {{ $profile->effective_commission_pct }}%
                        </span>
                    </div>

                    @if ($profile->nickname && $profile->nickname !== $profile->user->name)
                        <p class="mt-1 text-xs text-white/70 font-body">Nama Lengkap: {{ $profile->user->name }}</p>
                    @endif
                    ...
                    @if ($profile->niches && $profile->niches->isNotEmpty())
                        <div class="mt-3.5 flex flex-wrap items-center gap-1.5">
                            <span class="text-xs text-white/60 mr-1"><i class="bi bi-tags"></i> Niche:</span>
                            @foreach ($profile->niches as $niche)
                                <span class="rounded-lg bg-white/10 px-2.5 py-1 text-xs font-medium text-[#78a5d6] backdrop-blur-xs border border-white/10">
                                    #{{ $niche->name }}
                                </span>
                            @endforeach
                        </div>
    ...
    <div class="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        <div class="space-y-8">
            ...
            <div class="kerajaan-card overflow-hidden">
                <div class="border-b border-slate-100 bg-slate-50/70 px-6 py-4">
                    <div class="flex items-center gap-3">
                        <div class="flex size-8 items-center justify-center rounded-lg bg-[#0b64d4]/10 text-[#0b64d4]">
                            <i class="bi bi-person-lines-fill"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-extrabold text-[#071d49] font-heading">Informasi Pribadi & Kontak</h3>
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-medium text-[#071d49] flex items-center gap-1.5">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-medium text-[#071d49]">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-medium text-[#071d49] flex items-center gap-1.5">
                                <i class="bi bi-geo-alt-fill text-[#0b64d4]"></i>
            ...
            <div class="kerajaan-card overflow-hidden">
                <div class="border-b border-slate-100 bg-slate-50/70 px-6 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-[#071d49] font-heading">Rekening Bank & Pajak</h3>
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-bold text-[#071d49] font-heading">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-mono font-bold tracking-wide text-[#071d49]">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-mono font-medium text-[#071d49]">
                                {{ $profile->npwp ?: 'Tidak ada / Belum diisi' }}
                            </dd>
                        </div>
                    </dl>

                    <div class="mt-5 flex items-start gap-2.5 rounded-xl border border-slate-200 bg-slate-50/60 p-3 text-xs text-slate-600">
            ...
            <div class="kerajaan-card overflow-hidden">
                <div class="border-b border-slate-100 bg-slate-50/70 px-6 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-[#071d49] font-heading">Akun Media Sosial</h3>
                ...
                <div class="p-6">
                            ...
                            @foreach ($profile->socialMedia as $sm)
                                @php
                                    ...
                                    $icon = match (true) {
                                        ...
                                        str_contains($platformLower, 'face') => ['class' => 'bi-facebook', 'bg' => 'bg-blue-600/10 text-blue-600 border-blue-200'],
                                        str_contains($platformLower, 'thread') => ['class' => 'bi-threads', 'bg' => 'bg-neutral-900/10 text-neutral-900 border-neutral-300'],
                                        ...
                                        default => ['class' => 'bi-globe', 'bg' => 'bg-[#0b64d4]/10 text-[#0b64d4] border-[#0b64d4]/20'],
                                    };
                                @endphp
                                    ...
                                    <div class="flex items-center gap-3.5">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2">
                                                <h4 class="text-sm font-bold text-[#071d49] capitalize font-heading">{{ $sm->platform }}</h4>
                                                @if ($sm->profile_url)
                    ...
                    @else
                        <div class="rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 p-8 text-center">
                            <div class="mx-auto flex size-12 items-center justify-center rounded-full bg-[#0b64d4]/10 text-[#0b64d4]">
                                <i class="bi bi-share text-xl"></i>
                            </div>
                            <h4 class="mt-3 text-sm font-bold text-[#071d49] font-heading">Belum Ada Media Sosial</h4>
            ...
            <div class="kerajaan-card overflow-hidden">
                <div class="border-b border-slate-100 bg-slate-50/70 px-6 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-extrabold text-[#071d49] font-heading">Rate Card (Tarif Indikatif)</h3>
                ...
                <div class="p-6">
                    @if ($profile->rateCards && $profile->rateCards->isNotEmpty())
                        <div class="overflow-x-auto">
                            <table class="w-full text-left text-sm">
                                <thead class="border-b border-slate-100 bg-slate-50 text-[11px] font-bold uppercase tracking-wider text-slate-500 font-heading">
                                    <tr>
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    @foreach ($profile->rateCards as $rc)
                                        <tr class="hover:bg-slate-50/60 transition">
                                            <td class="px-4 py-3 font-semibold text-[#071d49] capitalize font-heading">
                                                {{ $rc->platform }}
                                            </td>
                    ...
                    @else
                        <div class="rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 p-8 text-center">
                            ...
                            <h4 class="mt-3 text-sm font-bold text-[#071d49] font-heading">Rate Card Belum Diatur</h4>
                            <p class="mt-1 text-xs text-slate-500">Atur tarif konten untuk tiap platform agar memudahkan penawaran kolaborasi.</p>
                        </div>
                    @endif

                    <div class="mt-5 rounded-xl border border-slate-200 bg-slate-50/60 p-3.5 text-xs text-slate-600">
                        <p class="font-semibold text-[#071d49] flex items-center gap-1.5">
