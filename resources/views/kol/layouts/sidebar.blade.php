<aside id="kol-dashboard-sidebar" class="fixed inset-y-0 left-0 z-40 flex h-screen w-72 -translate-x-full flex-col border-r border-white/10 bg-[#081d47] text-slate-300 transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:h-screen lg:w-72 lg:shrink-0 lg:translate-x-0">
    {{-- Brand Header --}}
    <div class="flex h-20 items-center gap-3 border-b border-white/10 px-6">
        <a href="{{ url('/') }}" class="flex items-center gap-3 group">
            ...
            <div class="leading-tight">
                ...
                <p class="text-[9px] font-bold tracking-[0.22em] text-[#1698f6] uppercase">CREATOR PORTAL</p>
            </div>
        </a>
    </div>
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6">
        <div class="mb-3 flex items-center justify-between px-3">
            <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#78a5d6]">Menu Creator</p>
        ...
        <div class="rounded-xl border border-white/10 bg-white/5 p-3.5 backdrop-blur-xs">
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 truncate text-[11px] text-slate-400">{{ auth()->user()->email ?? 'kol@majapahit.com' }}</p>
                </div>
            </div>
