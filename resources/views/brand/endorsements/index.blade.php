...
@section('content')
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-[#0c3685] font-heading">Endorsement KOL</h1>
                            ...
                            <tr class="group hover:bg-blue-50/40 transition">
                                <td class="px-5 py-4 sm:px-6">
                                    <div class="flex items-center gap-3">
                                        <div class="size-8 shrink-0 overflow-hidden rounded-full bg-blue-50 border border-slate-200">
                                        ...
                                        <div>
                                            <span class="font-bold text-[#0c3685] block font-heading">
                                ...
                                <td class="whitespace-nowrap px-5 py-4">
                                    <span class="font-semibold text-[#0c3685] block">{{ $endorsement->campaign->name }}</span>
                                </td>
