<aside id="brand-dashboard-sidebar" class="fixed inset-y-0 left-0 z-40 flex h-screen w-72 -translate-x-full flex-col border-r border-[#421b13]/30 bg-[#240e09] text-white/80 transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:h-screen lg:w-72 lg:shrink-0 lg:translate-x-0">
    {{-- Brand Header --}}
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6">
        <div class="mb-3 flex items-center justify-between px-3">
            <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#d57028]">Menu Brand</p>
        ...
        <div class="rounded-xl border border-white/5 bg-[#31140d]/80 p-3.5 backdrop-blur-xs">
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 truncate text-[11px] text-white/70">{{ auth()->user()->email ?? 'brand@majapahit.com' }}</p>
                </div>
            </div>
