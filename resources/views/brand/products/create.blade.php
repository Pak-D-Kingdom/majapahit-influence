        ...
        <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs space-y-5">
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Radiant Glow Serum Vitamin C 30ml" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#0b64d4] focus:ring-2 focus:ring-blue-500/20 focus:outline-hidden" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price') }}" placeholder="Contoh: 125000" class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#0b64d4] focus:ring-2 focus:ring-blue-500/20 focus:outline-hidden" required>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="Jelaskan manfaat produk, bahan aktif utama, cara pemakaian, dan sertifikasi BPOM/Halal..." class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-400 focus:border-[#0b64d4] focus:ring-2 focus:ring-blue-500/20 focus:outline-hidden" required>{{ old('description') }}</textarea>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="file" name="image" id="image" accept="image/*" class="mt-2 block w-full rounded-xl border border-dashed border-slate-300 bg-slate-50/60 p-3 text-xs text-slate-600 file:mr-3 file:rounded-lg file:border-0 file:bg-blue-50 file:px-3 file:py-1.5 file:text-xs file:font-bold file:text-[#0b64d4]" required>
                </div>
            </div>
        </div>
